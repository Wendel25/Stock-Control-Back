...
var ListCategoriesService_1 = require("../../services/category/ListCategoriesService");
var ListCategoriesController = /** @class */ (function () {
    ...
    ListCategoriesController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var listCategoryService, categories;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        listCategoryService = new ListCategoriesService_1.ListCategoriesService();
                        return [4 /*yield*/, listCategoryService.execute()];
                    case 1:
                        categories = _a.sent();
