...
var DeleteCategoryService_1 = require("../../services/category/DeleteCategoryService");
var DeleteCategoryController = /** @class */ (function () {
    ...
    DeleteCategoryController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var category_id, removeCategoryService, category;
            return __generator(this, function (_a) {
                category_id = request.query.category_id;
                removeCategoryService = new DeleteCategoryService_1.DeleteCategoryService();
                category = removeCategoryService.execute(category_id);
